import type { SlackMessageJson } from './slackMessages/schema'
...
// is the channel name).
const modules = import.meta.glob<SlackMessageJson[]>('./slackMessages/*.json', {
  eager: true,
  import: 'default',
})

export const slackChannels: Record<string, SlackMessageJson[]> = Object.fromEntries(
